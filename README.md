...
<p align="center">
  <a href="https://github.com/MehedisGits">
    <img src="https://github.com/MehedisGits/MehedisGits/blob/main/banner3.png" width="auto" style="border-radius:100%;" alt="Rakibul's Avatar" />
  </a>
</p>
...
class Rakibul {
  ...
  final List<String> techStack = ["Flutter", "Dart", "Firebase", "REST API", "SSL-Commerz & Stripe", "Admob, Meta Audience Network", "And Others Third Party Services"];
  final bool openSourceContributor = true;

  void build() {
    developBeautifulApps();
    contributeToCommunity();
    writeCleanScalableCode();
  }
}
````

💡 I'm a cross-platform Mobile Application Developer passionate about building robust Flutter mobile applications.
🎯 Focused on learning daily, writing clean, maintainable code and contributing to the open-source world.
📫 Reach me: **[rakibulislammehedi4@gmail.com](mailto:rakibulislammehedi4@gmail.com)**

---

## 🌐 Socials:

[![Discord](https://img.shields.io/badge/Discord-%237289DA.svg?logo=discord\&logoColor=white)](https://discord.gg/Qpaxf8df)
[![Facebook](https://img.shields.io/badge/Facebook-%231877F2.svg?logo=Facebook\&logoColor=white)](https://facebook.com/rakibulmehedi02)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin\&logoColor=white)](https://linkedin.com/in/rakibul-islam-mehedi-a1b8ba1bb?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app)
[![X](https://img.shields.io/badge/X-black.svg?logo=X\&logoColor=white)](https://x.com/rakibulislammehedi02)
...
![Java - Intermediate](https://img.shields.io/badge/java-%23ED8B00.svg?style=flat\&logo=openjdk\&logoColor=white)
![MySQL - Basic](https://img.shields.io/badge/mysql-4479A1.svg?style=flat\&logo=mysql\&logoColor=white) - (Basic)
...
![Meta Bsuiness](https://img.shields.io/badge/Meta-%230467DF.svg?style=flat\&logo=Meta\&logoColor=white)
...
### ✅ [Taskly](https://github.com/MehedisGits/Taskly) – Task Management App

Smart & minimal task management app to organize your goals and get more done.

---

### 🔐 [Flutter GetX Login UI Flow](https://github.com/MehedisGits/flutter_getx_login_flow)

A reusable login/signup flow built with GetX. Authentication-ready with best practices.
